...
import { runBacktest, BacktestInput, BacktestResult } from '../backtestingEngine';
import * as historicalPriceQuery from '../historicalPriceQuery';

// Mock the historicalPriceQuery module
jest.mock('../historicalPriceQuery');
