 ...
 * 
 * Uses OpenAI GPT-4o and Gemini AI for the most advanced trade analysis
...
/**
 * Generate comprehensive AI analysis using OpenAI GPT-4o
 */
...
export async function generateComprehensiveAnalysis(
  ...
  console.log(`[ATGE] Calling OpenAI GPT-4o and Gemini AI for analysis...`);
...
- AI Models: OpenAI GPT-4o, Gemini 2.0 Flash`;
