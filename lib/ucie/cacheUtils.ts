...
export async function setCachedAnalysis(
  ...
  try {
    ...
    // This ensures every query gets fresh data
    await query(
    ...
    console.log(`✅ Analysis cached for ${symbol}/${analysisType} (TTL: ${ttlSeconds}s, quality: ${dataQualityScore || 'N/A'}, REPLACED old data)`);
  } catch (error) {
