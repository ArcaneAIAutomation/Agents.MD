...
// Main component
export default function CryptoNewsHub() {
  const [nexoNews, setNexoNews] = useState<NewsArticle[]>([]);
  const [btcData, setBtcData] = useState<{ marketData: MarketData; analysis: TechnicalAnalysis[] } | null>(null);
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            <div className="loading-pulse h-8 w-64 mx-auto mb-4"></div>
            <div className="loading-pulse h-4 w-32 mx-auto"></div>
          </div>
        </div>
      </div>
    );
