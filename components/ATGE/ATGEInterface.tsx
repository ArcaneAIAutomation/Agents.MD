...
export default function ATGEInterface({ className = '' }: ATGEInterfaceProps) {
  ...
  const [selectedSymbol, setSelectedSymbol] = useState<'BTC'>('BTC'); // ✅ BITCOIN-FIRST: Focus on perfecting BTC
        ...
        {!isMobile && (
          <div className="grid grid-cols-4 gap-4 mt-4 mb-4">
            <div className="text-center">
              ...
              <div className="text-bitcoin-white-60 text-xs uppercase tracking-wider">GPT-5.1 + Gemini 2.5</div>
            </div>
            <div className="text-center">
        ...
        {isMobile && (
          <div className="grid grid-cols-2 gap-3 mt-3 mb-3">
            <div className="text-center bg-bitcoin-black border border-bitcoin-orange-20 rounded-lg p-2">
              ...
              <div className="text-bitcoin-white-60 text-xs">GPT-5.1 + Gemini 2.5</div>
            </div>
            <div className="text-center bg-bitcoin-black border border-bitcoin-orange-20 rounded-lg p-2">
