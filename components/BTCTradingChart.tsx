    ...
    return (
      <div className="bg-white rounded-lg shadow-lg p-4 md:p-6 mobile-bg-primary">
        <div className="text-center">
          ...
          {loading && (
            <div className="mt-4 md:mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4 mobile-bg-secondary">
              <div className="flex items-center justify-center">
                <div className="animate-spin rounded-full h-5 w-5 md:h-6 md:w-6 border-b-2 border-yellow-600 mr-2 md:mr-3"></div>
                <div className="text-sm md:text-base text-yellow-800 font-medium mobile-text-primary">
