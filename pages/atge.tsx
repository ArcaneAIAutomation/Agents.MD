  ...
  return (
    <>
      <Head>
        ...
        <meta 
          name="description" 
          content="Ultimate AI-powered Bitcoin trade signals with Dual AI (ChatGPT 5.1 + Gemini 2.5 Pro). 13 real-time data sources, 4 timeframes, 100% transparency." 
        />
        <meta name="keywords" content="Bitcoin, AI trading, trade signals, ChatGPT 5.1, Gemini 2.5 Pro, cryptocurrency, technical analysis, real-time data" />
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-sm text-bitcoin-white-60">GPT-5.1 + Gemini 2.5</div>
                </div>
                <div className="text-center">
                  <div className="flex justify-center mb-2">
